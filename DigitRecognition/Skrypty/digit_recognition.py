...
model.fit(x_train, y_train, epochs=50)  # epochs = how many times goes through data set
...
# saving a model
model.save("D:\PythonProjekty\Digit_recognition\DigitRecognition\models\digit_recognition4.model")
#new_model = tf.keras.models.load_model('D:\PythonProjekty\Digit_recognition\DigitRecognition\models\\num_rec2.model')
# create jpg
...
def funct():
    ...
    print(a)
    pkt =jpg_to_28_x_28_matrix.print_result_of_prediction(a)
